                        ...
                        <Grid  xs={12} md={6} lg={4} >
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <Avatar src={`${import.meta.env.VITE_APP_URL}/img/vehicles/sedan.png`} sx={{ height: 80, mb: 2, width: 80 }}
                                    />
                                        ...
                                        <Box sx={{ m: -1.5 }}>
                                            <Grid container spacing={3}>
                                                ...
                                                <Grid xs={12}>
                                                    ...
                                                    >
                                                        <FormControlLabel checked value="active" control={<Radio />} label="Active" />
